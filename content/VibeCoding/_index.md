...
> Cursor AI 编程实战指南 — 从入门到精通的系统化知识库
...
Cursor 是一个基于 VSCode 的 AI 代码编辑器，核心理念是"AI 不是助手，是 Co-pilot"。
...
```
Week 1: 入门 — 用 AI 完成日常编码任务
Week 2: 进阶 — 用 Rule 规范项目 AI 行为
Week 3: 精通 — 自定义 Command 提升效率
Week 4+: 专家 — Skills 和 Subagent 处理复杂场景
```
...
| 能力 | 说明 |
|------|------|
| 💬 **代码对话** | 选中代码 Cmd+L，AI 分析解释优化 |
| 🎯 **项目级提问** | Cmd+K 引用整个项目，跨文件智能搜索 |
| ✏️ **内联编辑** | 选中代码输入指令，AI 原位修改 |
| 📝 **Skills** | 可复用的 AI 能力模块，让 AI 成为领域专家 |
| 🤖 **Subagent** | 多 Agent 协作，架构师+开发者+测试员+审查员 |
