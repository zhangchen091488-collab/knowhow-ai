...
你好！我是 **晨老师**，一位写了多年 C++ 的移动端后端工程师。

最近正在「驯养」一群 AI 助手——Cursor、OpenClaw，还有各种效率工具。

与其说是老师，不如说是个 **持续学习的小白**。这里记录的是我探索 AI 编程的过程：

- 踩过的坑 🕳️
- 学会的招 🛠️
- 忘性太大，需要反复查看的笔记 📝

**如果你也是刚开始玩 AI 编程，欢迎来看看，或许能少走些弯路。**

<div class="hero-buttons">
  <a href="#cursor" class="button primary">💠 看看我在学什么</a>
  <a href="#openclaw" class="button secondary">🦞 了解我的养虾装备</a>
</div>
...
<div class="gear-grid">
  <div class="gear-card">
    <h4>🚀 快速开始</h4>
    <ul>
      <li><a href="06-OpenClaw/01-OpenClaw 快速入门">4 步安装</a></li>
      <li><a href="06-OpenClaw/02-OpenClaw 安装方法">详细文档</a></li>
    </ul>
  </div>
  <div class="gear-card">
    <h4>⚙️ 配置调优</h4>
    <ul>
      <li><a href="06-OpenClaw/03-OpenClaw 配置指南">配置文件</a></li>
      <li><a href="06-OpenClaw/04-OpenClaw CLI 参考">CLI 命令</a></li>
    </ul>
  </div>
  <div class="gear-card">
    <h4>🔧 进阶玩法</h4>
    <ul>
      <li><a href="06-OpenClaw/05-OpenClaw 架构概念">架构理解</a></li>
